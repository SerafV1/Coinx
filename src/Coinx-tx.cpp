...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Coinx Core Coinx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Coinx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Coinx transaction") + "\n" +
                               "  Coinx-tx [options] -create [commands]   " + _("Create hex-encoded Coinx transaction") + "\n" +
                               "\n";
